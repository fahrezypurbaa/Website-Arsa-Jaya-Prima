        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('company') is-invalid @enderror" id="company" name="company" autofocus value="{{ old('company') }}">
                    @error('company')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    >
                    <textarea id="review" name="review" class="form-control review" style="height: 100px">{{ old('review') }}</textarea>
                    @error('review')
