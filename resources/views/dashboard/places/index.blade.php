        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="option-item ">
                    ...
                    <a
                    href="/dashboard/places/{{ $places->slug }}"
                    class="btn btn-tertiary btn-sm m-auto"
                    >
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    {{-- <a
                    href="{{ route('place.images', $places->id) }}"
                    class="btn btn-tertiary btn-sm m-auto"
                    >
                        <i class="fa-solid fa-eye"></i>
                    </a> --}}
                    <a>
                        <form action="/dashboard/places/{{ $places->id }}" method="post" class="d-inline">
                            @method('delete')
                            @csrf
