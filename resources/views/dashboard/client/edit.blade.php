    ...
    <div class="slider-section section-padding px-3 py-2 bg-white rounded">
        <div class="row">
            <div class="col-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                    <a href="/dashboard/client" class="text-primary">
        ...
        <div class="row">
            <div class="col-md-10">
                <form
                method="post"
                action="/dashboard/client/{{$client->id}}"
                class="mb-5"
                ...
                <div class="mb-3">
                    <label for="image" class="form-label">Gambar Client</label>
                    <input type="hidden" name="oldImage" value="{{$client->image}}" disabled>
                    @if($client->image)
                    <img loading="lazy" src="{{ asset('storage/' .$client->image) }}" class="img-fluid mb-2"
                        alt="{{ $client->name }}" style="height: 100px; width: 100px;">
                    @else
