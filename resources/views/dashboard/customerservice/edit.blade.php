...
@section('container')
    ...
    <div class="staff-section section-padding px-3 py-2 bg-white rounded">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <i class="fa-solid fa-pencil me-1"></i> Tambah Customer Service
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <form method="post" action="/dashboard/customer-service/{{ $staff->slug }}" class="mb-5"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name')is-invalid @enderror"
                            id="name" required autofocus value="{{ old('name', $staff->name) }}">
                        @error('name')
                    ...
                    <div class="mb-3" hidden>
                        ...
                        <input type="text" name="slug" class="form-control @error('slug')is-invalid @enderror"
                            id="slug" required autofocus value="{{ old('slug', $staff->slug) }}">
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone')is-invalid @enderror"
                            id="phone" autofocus value="{{ old('phone', $staff->phone) }}">
                        @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jabatan" class="form-control @error('jabatan')is-invalid @enderror"
                            id="jabatan" required autofocus value="{{ old('jabatan', $staff->jabatan) }}">
                        @error('jabatan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <label for="banner" class="form-label">Foto <span class="text-danger">*</span></label>
