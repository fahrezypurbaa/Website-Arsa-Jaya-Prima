        ...
        <div class="row">
            <div class="col-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <i class="fa-solid fa-plus me-1"></i> Tambah Video dan Deskripsi Galeri
                    </li>
                </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control description" style="height: 100px">{{ old('description') }}</textarea>
                    @error('description')
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('thumbnail') is-invalid @enderror" type="file" id="thumbnail" name="thumbnail" required onchange="previewImage()">
                        @error('thumbnail')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
