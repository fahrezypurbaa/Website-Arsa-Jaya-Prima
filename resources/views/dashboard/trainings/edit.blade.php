...
@section('container')
    ...
    <div class="program-section section-padding px-3 py-2 bg-white rounded">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="/dashboard/trainings/{{ $training->slug }}" class="mb-5"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" required autofocus value="{{ old('name', $training->name) }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                            name="slug" required value="{{ old('slug', $training->slug) }}">
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <select class="form-select" name="training_categories_id">
                            @foreach ($trainingcategories as $category)
                                <option value="{{ $category->id }}"
                                    {{ old('training_categories_id', $training->training_categories_id) == $category->id ? 'selected' : null }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="home_view">
                            <option value="{{ $training->home_view }}"
                                {{ old('home_view', $training->home_view) == $training->home_view ? 'selected' : null }}>
                                {{ $training->home_view }}</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kategori_sertifikasi">
                            <option value="{{ $training->kategori_sertifikasi }}"
                                {{ old('kategori_sertifikasi', $training->kategori_sertifikasi) == $training->kategori_sertifikasi ? 'selected' : '' }}>
                                {{ $training->kategori_sertifikasi }}
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('total_waktu') is-invalid @enderror"
                            id="total_waktu" name="total_waktu" required autofocus
                            value="{{ old('total_waktu', $training->total_waktu) }}">
                        @error('total_waktu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="deskripsi_persyaratan" type="hidden" name="deskripsi_persyaratan" class="form-control editor">{{ old('deskripsi_persyaratan', $training->deskripsi_persyaratan) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="platform" type="hidden" name="platform" class="form-control editor">{{ old('platform', $training->platform) }}</textarea>
                        @error('platform')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="oldThumbnail" value="{{ $training->thumbnail }}">
                        @if ($training->thumbnail)
                            <img src="{{ asset('storage/' . $training->thumbnail) }}"
                                class="thumbnail-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
                        ...
                        <input class="form-control @error('thumbnail') is-invalid @enderror" type="file"
                            id="thumbnail" name="thumbnail" onchange="previewThumbnail()">
                        @error('thumbnail')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <label for="thumbnail-mobile" class="form-label">Thumbnail Mobile <span
                                class="text-danger">*</span></label>
                        <input type="hidden" name="oldThumbnailMobile" value="{{ $training->thumbnail_mobile }}">
                        @if ($training->thumbnail_mobile)
                            <img src="{{ asset('storage/' . $training->thumbnail_mobile) }}"
                                class="thumbnail-preview-mobile img-fluid mb-3 col-sm-5 d-block">
                        @else
                    ...
                    <div class="mb-3">
                        <label for="thumbnail-jadwal" class="form-label">Thumbnail jadwal <span
                                class="text-danger">*</span></label>
                        <input type="hidden" name="oldThumbnailJadwal" value="{{ $training->thumbnail_jadwal }}">
                        @if ($training->thumbnail_jadwal)
                            <img src="{{ asset('storage/' . $training->thumbnail_jadwal) }}"
                                class="thumbnail-preview-jadwal img-fluid mb-3 col-sm-5 d-block">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pricelist') is-invalid @enderror"
                            name="pricelist" autofocus value="{{ old('pricelist', $training->pricelist) }}">
                        @error('pricelist')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <label for="description" class="form-label">Deskripsi (Description) <span
                                class="text-danger">*</span></label>
                        <textarea id="description" type="hidden" name="description" class="editor">{{ old('description', $training->description) }}</textarea>
                        @error('description')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label for="outline" class="form-label">Materi (Outline) <span
                                class="text-danger">*</span></label>
                        <textarea id="outline" type="hidden" name="outline" class="editor">{{ old('outline', $training->outline) }}</textarea>
                        @error('outline')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="requirement" type="hidden" name="requirement" class="editor">{{ old('requirement', $training->requirement) }}</textarea>
                        @error('requirement')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="method" type="hidden" name="method" class="editor">{{ old('method', $training->method) }}</textarea>
                        @error('method')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('durasi') is-invalid @enderror" id="durasi"
                            name="durasi" autofocus value="{{ old('durasi', $training->durasi) }}">
                        @error('durasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('metode') is-invalid @enderror" id="metode"
                            name="metode" utofocus value="{{ old('metode', $training->metode) }}">
                        @error('metode')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <label for="facility" class="form-label">Fasilitas (Facility) <span
                                class="text-danger">*</span></label>
                        <textarea id="facility" type="hidden" name="facility" class="editor">{{ old('facility', $training->facility) }}</textarea>
                        @error('facility')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="jadwal" type="hidden" name="jadwal" class="editor">{{ old('jadwal', $training->jadwal) }}</textarea>
                        @error('jadwal')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="rundown" type="hidden" name="rundown" class="editor">{{ old('rundown', $training->rundown) }}</textarea>
                        @error('rundown')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="pemateri" type="hidden" name="pemateri" class="editor">{{ old('pemateri', $training->pemateri) }}</textarea>
                        @error('pemateri')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea id="tujuan" type="hidden" name="tujuan" class="editor">{{ old('tujuan', $training->tujuan) }}</textarea>
                        @error('tujuan')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label for="paket_harga" class="form-label">Paket Harga <span
                                class="text-danger">*</span></label>
                        <textarea id="paket_harga" type="hidden" name="paket_harga" class="editor">{{ old('paket_harga', $training->paket_harga) }}</textarea>
                        @error('paket_harga')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label for="paket_harga_2" class="form-label">Paket Harga Program Ke-2<span
                                class="text-danger">*</span></label>
                        <textarea id="paket_harga_2" type="hidden" name="paket_harga_2" class="editor">{{ old('paket_harga_2', $training->paket_harga_2) }}</textarea>
                        @error('paket_harga_2')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="meta_desc" name="meta_desc" class="form-control meta_desc" style="height: 100px">{{ old('meta_desc', $training->meta_desc) }}</textarea>
                        @error('meta_desc')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control keywords" id="keywords" name="keywords"
                            value="{{ old('keywords', $training->keywords) }}">
                        @error('keywords')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
