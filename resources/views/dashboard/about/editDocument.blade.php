    ...
    <div class="about-section section-padding px-3 py-2 bg-white rounded">
        ...
        <div class="row">
            <div class="col-md-10">
                <form
                method="post"
                action="/dashboard/about/document/update/{{ $document->id}}"
                class="mb-5"
                ...
                <div class="mb-3">
                    ...
                    <input id="title" name="title" class="form-control title" required autofocus value="{{ old('title', $document->title) }}">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <select id="type" name="type" class="form-control type">
                        <option value="{{$document->type}}" selected>{{$document->type}}</option>
