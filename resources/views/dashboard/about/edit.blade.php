    ...
    <div class="about-section section-padding px-3 py-2 bg-white rounded">
        <div class="row">
            <div class="col-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <i class="fa-solid fa-pen me-1"></i> Edit Profil Perusahaan
                    </li>
                </ol>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-md-10">
                <form
                method="post"
                action="/dashboard/about/{{ $about->id }}"
                class="mb-5"
                ...
                <div class="mb-3">
                    ...
                    <textarea id="privilege" name="privilege" class="form-control privilege" style="height: 100px">{{ old('privilege', $about->privilege) }}</textarea>
                    @error('privilege')
                ...
                <div class="mb-3">
                    ...
                    <textarea id="vission" name="vission" class="form-control vission" style="height: 100px">{{ old('vission', $about->vission) }}</textarea>
                    @error('vission')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <textarea id="mission" name="mission" class="form-control mission" style="height: 100px">{{ old('mission', $about->mission) }}</textarea>
                    @error('mission')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    <label for="link" class="form-label">Link Video <span class="text-danger">(link embed)</span></label>
                    <input type="text" class="form-control @error('link') is-invalid @enderror" id="link" name="link" autofocus value="{{ old('link', $about->link) }}">
                    @error('link')
