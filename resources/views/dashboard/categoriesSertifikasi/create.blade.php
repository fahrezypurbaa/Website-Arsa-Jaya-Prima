...
<div class="category-section section-padding px-3 py-2 bg-white rounded">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/dashboard/kategoriSertifikasi/create" class="text-primary">
                            <i class="fa-solid fa-rectangle-list"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <i class="fa-solid fa-plus me-1"></i> Tambah Kategori Sertifikasi
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <form
                method="post"
                action="/dashboard/kategoriSertifikasi"
                class="mb-5"
                ...
                <div class="mb-3">
                    <label  for="thumbnail" class="form-label">Gambar<span class="text-danger">*</span></label>
                     <img class="thumbnail-preview img-fluid mb-3 col-sm-5">
                    <input class="form-control @error('img_kategori') is-invalid @enderror" type="file" id="thumbnail" name="img_kategori" required onchange="previewThumbnail()">
                    @error('img_kategori')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
