    ...
    <div class="slider-section section-padding px-3 py-2 bg-white rounded">
        ...
        <div class="row">
            <div class="col-md-10">
                <form
                method="post"
                action="/dashboard/sliders/{{ $slider->slug }}"
                class="mb-5"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" required autofocus value="{{ old('title', $slider->title) }}">
                    @error('title')
                ...
                <div class="mb-3" hidden>
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" required value="{{ old('slug', $slider->slug) }}">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    >
                    <input type="hidden" name="oldImageMobile" value="{{ $slider->image_mobile }}">
                    @if ($slider->image_mobile)
                        <img src="{{ asset('storage/' .$slider->image_mobile) }}" class="img-preview-mobile img-fluid mb-3 col-sm-5 d-block">
                    @else
                        <img class="img-preview-mobile img-fluid mb-3 col-sm-5">
                    @endif
                    <input class="form-control @error('image_mobile') is-invalid @enderror" type="file" id="image_mobile" name="image_mobile" onchange="previewImageMobile()">
                        @error('image_mobile')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
