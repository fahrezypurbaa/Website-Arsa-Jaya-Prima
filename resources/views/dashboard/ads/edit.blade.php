            ...
            <div class="col-md-10">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="oldImage" value="{{ $ad->image }}">
                        @if ($ad->image)
                            <img src="{{ asset('storage/' .$ad->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
                            <img class="img-preview img-fluid mb-3 col-sm-5">
                        @endif
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('button') is-invalid @enderror" id="button" name="button" value="{{ old('button', $ad->button) }}">
                    @error('button')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('link') is-invalid @enderror" id="link" name="link" autofocus value="{{ old('link', $ad->link) }}">
                    @error('link')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
