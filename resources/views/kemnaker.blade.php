    ...
    <div
      ...
      <div class="form">
          ...
          <div class="col-12 col-md-8 d-flex align-items-center">
            <div class="title">
              <h3 class="text-capitalize mb-2 ">
                Formulir Registrasi Sertifikasi KEMNAKER RI
              </h3>
              <p>
        ...
        <div class="form-registration px-lg-5">
          ...
          @endif
          <form method="post" action="/pendaftaran-sertifikasi-kemnaker-ri" enctype="multipart/form-data">
            @csrf
...
<script>
  ...
  name.addEventListener('change', function() {
    fetch('/pendaftaran-sertifikasi-kemnaker-ri/checkSlug?name=' + name.value)
