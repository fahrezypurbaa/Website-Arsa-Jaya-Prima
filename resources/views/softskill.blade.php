...
<!-- page title -->
<section class="page-title-section" data-background="img/banner/banners-softskill.webp" style="background-position: 50% 50%; background-repeat: no-repeat; background-size: cover;" data-stellar-background-ratio="0.5">
    ...
    <div class="row">
      <div class="col-md-8 section-padding">
        ...
        <p class="mb-4 text-light">
          Daftarkan dirimu pada program pelatihan softskill dan tingkatkan kredibilitas karirmu dengan sertifikasi yang berlisensi resmi
        </p>
      </div>
    </div>
  </div>
        ...
        <div class="form">
          <div class="row d-flex justify-content-center mb-md-5">
            ...
            <div class="col-12 col-md-8 d-flex align-items-center">
              <div class="title">
                <h3 class="text-capitalize mb-2 fs-1">
                  Formulir Registrasi Upskill Training
                </h3>
                <p>
          ...
          <div class="form-registration w-100">
            ...
            @endif
            <form method="post" action="/pendaftaran-training-softskill" enctype="multipart/form-data">
              @csrf
            ...
            @enderror</textarea>
              ...
              <div class="mb-3">
                <label for="program" class="form-label">Program Sertifikasi Upskill Taining yang dipilih
                  <span class="text-danger">*</span></label>
...
<script>
  ...
  name.addEventListener('change', function() {
    fetch('/pendaftaran-training-softskill/checkSlug?name=' + name.value)
